...
if not os.path.exists('/content/data/'):
    ...
    api_token = {"username":"kishan30r","key":"e716979cd4f6b9dd669b9d83d630360d"}
...
url = "https://th.bing.com/th/id/OIP.2Xx2wpeosPEpCx3kK0filwHaE6?w=250&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
...
def text_to_audio(input_string):
  audio=gTTS(input_string)
  audio.save("ex.mp3")
text_to_audio(pred_caption)

from IPython.display import Audio
Audio('ex.mp3', autoplay=True)